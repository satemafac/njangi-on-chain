...
- Contributions are made in crypto assets (stablecoins or SUI), not in CFA francs.
- Crypto prices can change fast. Even "stablecoins" can lose their fixed value.
- The value you get out may be worth less than the value you put in.
...
- Smart contracts are code, and code can contain errors or be attacked.
- The price information the app uses comes from outside sources ("oracles") that can be wrong or out of date.
- A serious bug could delay your payout or, in the worst case, lose funds. Use amounts you can afford to lose.
...
- Laws on crypto assets and savings groups are still evolving in Cameroon, the CEMAC region, and elsewhere.
- New rules could restrict the Service, your ability to buy or sell crypto, or the value of your assets.
- It is your responsibility to make sure using the Service is legal where you live.
