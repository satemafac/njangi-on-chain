...
The Service is **non-custodial**. Funds contributed to a circle are held by smart contracts on the Sui blockchain, in escrow for the current cycle, under rules fixed in the published contract code. Njangi On-Chain:
...
Payouts are **permissionless and member-initiated**: the scheduled recipient claims the cycle's pool directly from the contract. A member-initiated recovery mechanism exists in the contracts for certain failure scenarios; its operation is governed solely by the contract code, and Njangi On-Chain cannot trigger it, accelerate it, or override it on your behalf.

**There is no deposit insurance.** Funds in circles are not protected by any government deposit-guarantee scheme, and no person — including Njangi On-Chain — guarantees their return.

Suspension or termination of your access to the Service interface (Section 12) does not affect the smart contracts, which remain accessible on the public Sui network independent of Njangi On-Chain.
...
- **Njangi On-Chain does not vet, endorse, or guarantee any circle member**, does not underwrite counterparty risk, and is not a party to any circle;
...
- any dispute between circle members (including non-payment, ordering of payouts, or exclusion of a member) is a matter between those members. Njangi On-Chain has no obligation, and in a non-custodial system no technical ability, to adjudicate or remedy such disputes by moving funds.
...
- **Billing.** Subscriptions are billed through **Stripe**, our payment processor. Your card and payment details are collected and processed by Stripe under its own terms and privacy policy; Njangi On-Chain never receives your full card details.
...
- **What is never paywalled.** Access to your funds is never conditioned on payment. **Claiming a payout, withdrawing or recovering funds, and the member-initiated recovery mechanism are available on all tiers, at no charge from Njangi On-Chain, at all times.** If your subscription lapses, you lose Premium coordination features only.
- Network gas fees and partner fees (Section 7) are independent of any Njangi On-Chain subscription.
...
You agree to indemnify and hold harmless Njangi On-Chain and its officers, employees, and agents from claims, damages, and reasonable costs (including legal fees) arising from your breach of these Terms, your violation of applicable law, or your disputes with circle members or other third parties, except to the extent caused by our own breach or misconduct.
...
- **Entire agreement.** These Terms, the Privacy Policy, and the Risk Disclosure are the entire agreement between you and Njangi On-Chain concerning the Service.
