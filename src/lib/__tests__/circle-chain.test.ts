...
describe('circle-chain helpers', () => {
  ...
  describe('package lineage helpers', () => {
    ...
    it('returns lookup ids for the active upgrade lineage', () => {
      ...
      // published-at 0xf8afd3… (v9, 2026-09-06, real custody wallet_id; v8
      // duplicate-open guard, v7 deposits across laps); v6 0x859e3a… (2026-08-22) defined the timed-entry types and
