...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        {/* Favicon */}
        <link rel="icon" href="/njangi-on-chain-logo.png" />
        <link rel="apple-touch-icon" sizes="180x180" href="/njangi-on-chain-logo.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="/njangi-on-chain-logo.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/njangi-on-chain-logo.png" />
