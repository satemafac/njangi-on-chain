...
// Custom login component without in-app browser restrictions for homepage
function HomeLoginButton() {
  const { login } = useAuth();

  const handleLogin = async (provider: 'Google' | 'Facebook' | 'Apple') => {
    // Always proceed with login regardless of browser type
    login(provider);
  };
  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="inline-flex items-center px-6 py-3 rounded-lg text-gray-700 font-medium bg-white border border-gray-300 hover:bg-gray-50 transition-colors duration-200 text-lg shadow-lg"
      >
      ...
      <button
        ...
        className="inline-flex items-center px-6 py-2 rounded-lg text-white font-medium bg-blue-600 hover:bg-blue-700 transition-colors duration-200"
      >
      ...
      <button
        ...
        className="inline-flex items-center px-6 py-2 rounded-lg text-white font-medium bg-black hover:bg-gray-800 transition-colors duration-200"
      >
        <svg className="w-5 h-5 mr-2" viewBox="0 0 814 1000">
          <path
            fill="currentColor"
