...
echo "Downloading test zkey file for zkLogin (for Devnet)..."
...
cp zkLogin-test.zkey "$ORIGINAL_DIR/zkLogin.zkey"
...
echo "Download complete. zkLogin.zkey is now available in the current directory." Â